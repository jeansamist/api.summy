import { normalizeResourceName, toSnakeCase } from './support/text_processors.js'
...
export default class MakeRessource extends BaseCommand {
  ...
  private async linkServiceRepository(resourceName: string): Promise<void> {
    ...
    const servicesDirectory = fileURLToPath(new URL('../../domain/use_cases', import.meta.url))
